...
/**
 * Amazon S73/HS B2B four-SKU explicit-price LIVE v1.0.0
 * 2026-08-29
 *
 * Exact scope:
 * - Four approved S73/HS Seller SKUs only.
 ...
 */
const MODULE_VERSION = "2026-09-23-s73-b2b-four-live-v1.0.0";
const ROUTE = "/amazon/price/b2b/s73-four-live";
const LIVE_CONFIRM = "S73_B2B4_LIVE_APPROVED_20260923_V1";
...
const APPROVED = Object.freeze([
  Object.freeze({ sku: "s73-hs-i5-11g-8gb-ssd256", asin: "B0HJL5MCV9", normal: 35800, effective: 35800, points: 358, min: 28100, currentActualB2b: 34733, targetB2b: 34000 }),
  Object.freeze({ sku: "s73-hs-i5-11g-8gb-ssd512", asin: "B0HJLDDQQ3", normal: 49800, effective: 49800, points: 498, min: 42500, currentActualB2b: 48316, targetB2b: 47300 }),
  Object.freeze({ sku: "s73-hs-i5-11g-8gb-ssd1tb", asin: "B0HJL3QKXR", normal: 64800, effective: 64800, points: 648, min: 57000, currentActualB2b: 62869, targetB2b: 61500 }),
  Object.freeze({ sku: "7X-725F-2ZML", asin: "B0HGDBYRS8", normal: 43800, effective: 43800, points: 438, min: 39600, currentActualB2b: 52000, targetB2b: 41600 }),
]);
...
async function handler(req,res) {
  ...
  try {
    ...
    return res.status(200).json({ok:true,moduleVersion:MODULE_VERSION,route:ROUTE,decision:"LIVE_S73_B2B4_ALL_4_VERIFIED",validationPreviewCalls,liveCalls,persistentAmazonWrites:liveCalls,externalChanges:liveCalls,completed,nextStep:"RUN_S73_B2B4_FRESH_V120_RECONCILE_SSOT"});
  } catch(err) {
...
express.application.listen=function amazonS73B2BFourLiveListen(...args){
